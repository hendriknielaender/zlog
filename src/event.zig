...
pub const LogEvent = struct {
    ...
    pub fn initLegacy(
        ...
        _ = trace_mod.bytes_to_hex_lowercase(&trace_id_expanded, &trace_id_hex_buf) catch unreachable;
        _ = trace_mod.bytes_to_hex_lowercase(&parent_id_generated, &span_id_hex_buf) catch unreachable;
        ...
        if (span_context_id) |sid| {
            ...
            _ = trace_mod.bytes_to_hex_lowercase(&span_bytes, &parent_hex_buf) catch unreachable;
