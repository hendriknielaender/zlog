...
pub fn LoggerWithRedaction(comptime cfg: config.Config, comptime redaction_options: redaction.RedactionOptions) type {
    ...
    return struct {
        ...
        pub fn spanStart(self: *Self, operation_name: []const u8, operation_fields: []const field.Field) correlation.Span {
            ...
            var span_fields_array = std.BoundedArray(field.Field, max_fields + 4).init(0) catch unreachable;
            span_fields_array.append(field.Field.string("span_mark", "start")) catch unreachable;
            span_fields_array.append(field.Field.uint("span_id", span_created.id)) catch unreachable;
            span_fields_array.append(field.Field.uint("task_id", span_created.task_id)) catch unreachable;
            span_fields_array.append(field.Field.uint("thread_id", span_created.thread_id)) catch unreachable;
        ...
        pub fn spanEnd(self: *Self, completed_span: correlation.Span, completion_fields: []const field.Field) void {
            ...
            var span_fields_array = std.BoundedArray(field.Field, max_fields + 5).init(0) catch unreachable;
            span_fields_array.append(field.Field.string("span_mark", "end")) catch unreachable;
            span_fields_array.append(field.Field.uint("span_id", completed_span.id)) catch unreachable;
            span_fields_array.append(field.Field.uint("task_id", completed_span.task_id)) catch unreachable;
            span_fields_array.append(field.Field.uint("thread_id", completed_span.thread_id)) catch unreachable;
            span_fields_array.append(field.Field.uint("duration_ns", @intCast(duration_elapsed_ns))) catch unreachable;
